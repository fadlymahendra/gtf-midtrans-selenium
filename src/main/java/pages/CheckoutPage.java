...
public class CheckoutPage {
    ...
    // private By creditDebitPayment = By.xpath("//a[@class='list' and @data-testid='list-item' and @href='#/credit-card']");    
    ...
    private By otpField = By.id("card-cvv");
    private By successButton = By.id("card-cvv");
